...
public:
   ...
   const bool SendMIME(const std::string &strFrom, const std::string &strTo, const std::vector<std::string> &headers, const std::string &strMail, const std::vector<std::string> &paths);
